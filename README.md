# YouTube Trademarks Icon 1200x1200 | (Holloway) Chew, Kean Ho's Visuals
...
a re-draw is required.

This project re-draws YouTube Trademarks Icon specifically for 1200x1200 size.
...
Please read through YouTube Brand Resources' Engineering Specification
(https://brand.youtube) before editing to avoid any unwanted legal implications.
Some very good read are:

1. **Only Icon Is Used** - https://brand.youtube/promoting-your-channel/
2. **Icon Specification** - https://brand.youtube/youtube-icon/
3. **Podcast & Music** - https://brand.youtube/podcast-badges/
4. **Color** - https://brand.youtube/color/
5. **Referencing 3rd-Party Channel** - https://brand.youtube/naming-and-third-party-content/

While not specified by YouTube, please ensure the outputs are also web ready.
Refer:
...
```
--------------------------------------------------------------------------------
Title: YouTube Trademarks Icon 1200x1200
Creators: (Holloway) Chew, Kean Ho
Contact: hello@chewkeanho.com
SKU: chewkeanho-visuals-trademarks-youtube-icon-1200x1200
UUID: B0A2FFDE-CEE9-4013-831B-B49DE1E25884
License: Creative Commons Attribution-NoDerivatives 4.0 International License
Made On: 2026-01-07
Made From: Malaysia, South East Asia
Procure: https://github.com/chewkeanho/chewkeanho-visuals-trademarks-youtube-icon-1200x1200
--------------------------------------------------------------------------------
```
